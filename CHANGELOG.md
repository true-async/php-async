...
- **#125 chaos coverage: `Future`/`FutureState` location accessors** — new `fuzzy-tests/future/locations.feature` exercises `getCreatedFileAndLine`/`getCreatedLocation`/`getCompletedFileAndLine`/`getCompletedLocation` on both classes; inspectors race the producer. Overall coverage 135/167 (80.8%).
