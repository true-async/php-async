...
static const zend_function_entry class_Async_ScopeProvider_methods[] = { ZEND_RAW_FENTRY(
		"provideScope",
		NULL,
		arginfo_class_Async_ScopeProvider_provideScope,
		ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
		NULL,
		NULL) ZEND_FE_END };

static const zend_function_entry class_Async_SpawnStrategy_methods[] = { ZEND_RAW_FENTRY(
		"beforeCoroutineEnqueue",
		NULL,
		arginfo_class_Async_SpawnStrategy_beforeCoroutineEnqueue,
		ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
		NULL,
		NULL) ZEND_RAW_FENTRY("afterCoroutineEnqueue",
							  NULL,
							  arginfo_class_Async_SpawnStrategy_afterCoroutineEnqueue,
							  ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
							  NULL,
							  NULL) ZEND_FE_END };

static const zend_function_entry class_Async_Scope_methods[] = {
	ZEND_ME(Async_Scope, inherit, arginfo_class_Async_Scope_inherit, ZEND_ACC_PUBLIC | ZEND_ACC_STATIC) ZEND_ME(
			Async_Scope,
			provideScope,
			arginfo_class_Async_Scope_provideScope,
			ZEND_ACC_PUBLIC) ZEND_ME(Async_Scope, __construct, arginfo_class_Async_Scope___construct, ZEND_ACC_PUBLIC)
			ZEND_ME(Async_Scope, asNotSafely, arginfo_class_Async_Scope_asNotSafely, ZEND_ACC_PUBLIC) ZEND_ME(
					Async_Scope, spawn, arginfo_class_Async_Scope_spawn, ZEND_ACC_PUBLIC)
					ZEND_ME(Async_Scope, cancel, arginfo_class_Async_Scope_cancel, ZEND_ACC_PUBLIC) ZEND_ME(
							Async_Scope,
							awaitCompletion,
							arginfo_class_Async_Scope_awaitCompletion,
							ZEND_ACC_PUBLIC) ZEND_ME(Async_Scope,
													 awaitAfterCancellation,
													 arginfo_class_Async_Scope_awaitAfterCancellation,
													 ZEND_ACC_PUBLIC) ZEND_ME(Async_Scope,
																			  isFinished,
																			  arginfo_class_Async_Scope_isFinished,
																			  ZEND_ACC_PUBLIC)
							ZEND_ME(Async_Scope, isClosed, arginfo_class_Async_Scope_isClosed, ZEND_ACC_PUBLIC) ZEND_ME(
									Async_Scope,
									isCancelled,
									arginfo_class_Async_Scope_isCancelled,
									ZEND_ACC_PUBLIC) ZEND_ME(Async_Scope,
															 setExceptionHandler,
															 arginfo_class_Async_Scope_setExceptionHandler,
															 ZEND_ACC_PUBLIC)
									ZEND_ME(Async_Scope,
											setChildScopeExceptionHandler,
											arginfo_class_Async_Scope_setChildScopeExceptionHandler,
											ZEND_ACC_PUBLIC) ZEND_ME(Async_Scope,
																	 onFinally,
																	 arginfo_class_Async_Scope_onFinally,
																	 ZEND_ACC_PUBLIC)
											ZEND_ME(Async_Scope,
													dispose,
													...
													ZEND_ACC_PUBLIC) ZEND_ME(Async_Scope,
																			 disposeSafely,
																			 arginfo_class_Async_Scope_disposeSafely,
																			 ZEND_ACC_PUBLIC)
													ZEND_ME(Async_Scope,
															disposeAfterTimeout,
															arginfo_class_Async_Scope_disposeAfterTimeout,
															ZEND_ACC_PUBLIC)
															ZEND_ME(Async_Scope,
																	getChildScopes,
																	arginfo_class_Async_Scope_getChildScopes,
...
static zend_class_entry *register_class_Async_Scope(zend_class_entry *class_entry_Async_ScopeProvider)
{
	...
	zend_string *attribute_name_Override_func_providescope_0 =
			zend_string_init_interned("Override", sizeof("Override") - 1, 1);
	zend_add_function_attribute(
			zend_hash_str_find_ptr(&class_entry->function_table, "providescope", sizeof("providescope") - 1),
			attribute_name_Override_func_providescope_0,
			0);
