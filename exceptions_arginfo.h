...
static const zend_function_entry class_Async_CompositeException_methods[] = { ZEND_ME(
		Async_CompositeException,
		addException,
		arginfo_class_Async_CompositeException_addException,
		ZEND_ACC_PUBLIC) ZEND_ME(Async_CompositeException,
								 getExceptions,
...
static zend_class_entry *register_class_Async_CompositeException(zend_class_entry *class_entry_Exception)
{
	...
	class_entry = zend_register_internal_class_with_flags(
			&ce, class_entry_Exception, ZEND_ACC_FINAL | ZEND_ACC_NO_DYNAMIC_PROPERTIES);
	...
	zend_declare_typed_property(class_entry,
								property_exceptions_name,
								&property_exceptions_default_value,
								ZEND_ACC_PRIVATE,
								NULL,
