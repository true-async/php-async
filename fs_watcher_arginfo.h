 ...
 * Stub hash: fd38b8153ef06a4dba4f06d80f054f5ffa00c3ce */
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Async_FileSystemWatcher___construct, 0, 0, 1)
	...
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, debounceMs, IS_LONG, 0, "0")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, maxHoldMs, IS_LONG, 0, "0")
...
static zend_class_entry *register_class_Async_FileSystemEvent(void)
{
	...
	zend_string *property_renamed_name = zend_string_init("renamed", sizeof("renamed") - 1, true);
	...
	zend_string_release_ex(property_renamed_name, true);

	zval property_changed_default_value;
	ZVAL_UNDEF(&property_changed_default_value);
	zend_string *property_changed_name = zend_string_init("changed", sizeof("changed") - 1, true);
	...
	zend_string_release_ex(property_changed_name, true);
