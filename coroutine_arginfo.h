...
static const zend_function_entry class_Async_Coroutine_methods[] = {
	ZEND_ME(Async_Coroutine, getId, arginfo_class_Async_Coroutine_getId, ZEND_ACC_PUBLIC) ZEND_ME(
			Async_Coroutine,
			asHiPriority,
			arginfo_class_Async_Coroutine_asHiPriority,
			ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
									 getContext,
									 arginfo_class_Async_Coroutine_getContext,
									 ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
															  getResult,
															  arginfo_class_Async_Coroutine_getResult,
															  ZEND_ACC_PUBLIC)
			ZEND_ME(Async_Coroutine, getException, arginfo_class_Async_Coroutine_getException, ZEND_ACC_PUBLIC) ZEND_ME(
					Async_Coroutine,
					getTrace,
					arginfo_class_Async_Coroutine_getTrace,
					ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
											 getSpawnFileAndLine,
											 arginfo_class_Async_Coroutine_getSpawnFileAndLine,
											 ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
																	  getSpawnLocation,
																	  arginfo_class_Async_Coroutine_getSpawnLocation,
																	  ZEND_ACC_PUBLIC)
					ZEND_ME(Async_Coroutine,
							getSuspendFileAndLine,
							arginfo_class_Async_Coroutine_getSuspendFileAndLine,
							ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
													 getSuspendLocation,
													 arginfo_class_Async_Coroutine_getSuspendLocation,
													 ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
																			  isStarted,
																			  arginfo_class_Async_Coroutine_isStarted,
																			  ZEND_ACC_PUBLIC)
							ZEND_ME(Async_Coroutine,
									isQueued,
									arginfo_class_Async_Coroutine_isQueued,
									ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
															 isRunning,
															 arginfo_class_Async_Coroutine_isRunning,
															 ZEND_ACC_PUBLIC)
									ZEND_ME(Async_Coroutine,
											isSuspended,
											arginfo_class_Async_Coroutine_isSuspended,
											ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
																	 isCancelled,
																	 arginfo_class_Async_Coroutine_isCancelled,
																	 ZEND_ACC_PUBLIC)
											ZEND_ME(Async_Coroutine,
													...
													ZEND_ACC_PUBLIC) ZEND_ME(Async_Coroutine,
																			 isFinished,
																			 arginfo_class_Async_Coroutine_isFinished,
																			 ZEND_ACC_PUBLIC)
													ZEND_ME(Async_Coroutine,
															getAwaitingInfo,
															arginfo_class_Async_Coroutine_getAwaitingInfo,
															ZEND_ACC_PUBLIC)
															ZEND_ME(Async_Coroutine,
																	cancel,
																	arginfo_class_Async_Coroutine_cancel,
																	ZEND_ACC_PUBLIC)
																	ZEND_ME(Async_Coroutine,
																			onFinally,
																			arginfo_class_Async_Coroutine_onFinally,
